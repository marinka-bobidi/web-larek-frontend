...
- содержит методы:
  getInformation: Метод для получения информации о продукте и обновления свойств объекта product
...
- содержит методы:
  ...
  items_to_id: Метод для получения массива идентификаторов товаров в корзине.
